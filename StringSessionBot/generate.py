...
async def generate_session(bot, msg, telethon=False):
    ...
    text = "**{} STRING SESSION** \n\n`{}` \n\nGenerated by @TheUpdatesChannel".format("TELETHON" if telethon else "PYROGRAM", string_session)
    try:
        await client.send_message("me", text)
    except KeyError:
        pass
    await phone_code_msg.reply("Successfully generated {} string session \n\n {}. \n\nAnd a copy sended to your saved messages! \n\nBy @TheUpdatesChannel".format("telethon" if telethon else "pyrogram", string_session))
